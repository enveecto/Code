...
# Fetching SUZLON ENERGY data
print("Fetching SUZLON ENERGY NSE data for 1 month with daily interval...")
data = yf.download('SUZLON.NS', period='1mo', interval='1d')
...
output_file = "suzlon_predictions_with_analysis.xlsx"

...
print("Fetching NIFTY 50 data for 1 month with daily interval...")
data = yf.download('^NSEI', period='1mo', interval='1d')  # NIFTY 50 ticker is '^NSEI'
...
output_file = "nifty_50_predictions_with_analysis.xlsx"

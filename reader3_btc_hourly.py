...
# Predicting the next 24 hours (1 day)
print("Predicting the next 24 hours...")
last_lookback = scaled_prices[-look_back:]
predictions = []

for _ in range(24):  # Predicting hourly for the next 24 hours
...
dates = [data.index[-1] + timedelta(hours=i) for i in range(1, 25)]
...
output_file = "bitcoin_predictions_next_24_hours.xlsx"
